...
Everything you enter is stored in `localStorage` on your device. AutoVault has no backend, no analytics, and no account system — nothing you record ever leaves your browser unless you explicitly export a backup. See **Settings → Data & Privacy** in the app for details, and **Settings → About → Terms of Use** for the full terms.
